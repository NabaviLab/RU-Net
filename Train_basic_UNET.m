function [model] = Train_basic_UNET(train_data_folder,validate_data_folder,augment,imageSize,epoches,learnrate,MiniBatchSize)
%Dina Abdelhafiz
...
notes=strcat('UNET','_epoches',epoches_str,'_augment',augmentstr);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
networkname='UNET';
